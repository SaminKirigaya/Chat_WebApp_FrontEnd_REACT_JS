        ...
        return (
            <Fragment>
                <div className='container-fluid d-flex justify-content-center mainnav p-0'>
                    ...
                    <input onChange={(e)=>{this.setState({searchname : e.target.value})}} type="text" className="form-control" placeholder="Search People username or Name" aria-label="Recipient's username" aria-describedby="button-addon2" />
                ...
                <h4 className='tagsearch headfont'>Friend Requests :</h4>
                <div className='friendbox'>
                    ...
                    <h5 className='text-center bodfont'>UwU No One Sent You Requests Saddd Life ...</h5>
                    </div> : null}
